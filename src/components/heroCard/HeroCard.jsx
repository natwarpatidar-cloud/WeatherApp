                            ...
                            weatherData && (
                                <>
                                    <div className="flex-shrink-0">
                                        <img src={weatherData?.current?.condition?.icon} className="h-16 w-16 md:h-20 md:w-20 text-gray-600" />
                                    </div>
                                    <div className="text-center sm:text-left">
                                        <div className="text-sm md:text-base text-gray-600">Today</div>
                                        <div className="text-3xl font-semibold md:text-4xl text-gray-700 mb-1">{weatherData?.location?.name}</div>
                                        <div className="text-sm md:text-base text-gray-600">Temperature: {weatherData?.current?.temp_c}&deg;C</div>
                                        <div className="text-sm md:text-base text-gray-500 font-medium">{weatherData?.current?.condition?.text}</div>
                                    </div>
                                </>
                            )
                        }
